...
[Paper](https://openaccess.thecvf.com/content/CVPR2025/html/Zhong_DexGrasp_Anything_Towards_Universal_Robotic_Dexterous_Grasping_with_Physics_Awareness_CVPR_2025_paper.html) · [PDF](https://openaccess.thecvf.com/content/CVPR2025/papers/Zhong_DexGrasp_Anything_Towards_Universal_Robotic_Dexterous_Grasping_with_Physics_Awareness_CVPR_2025_paper.pdf) · [Issues](https://github.com/StaryMoon/DexGrasp-Anything-Unofficial/issues) · [Release](https://github.com/StaryMoon/DexGrasp-Anything-Unofficial/releases)
...
<p align="center">
  <img src="assets/paper-preview.png" alt="DexGrasp-Anything-Unofficial paper or project page preview" width="900">
</p>
...
| Focus | This repository organizes a PyTorch implementation for DexGrasp Anything: Towards Universal Robotic Dexterous Grasping with Physics Awareness, focusing on physics-aware universa... |
...
This repository organizes a PyTorch implementation for **DexGrasp Anything: Towards Universal Robotic Dexterous Grasping with Physics Awareness**, focusing on physics-aware universal dexterous grasping. The codebase is structured like a standard research repository so that model components, configuration files, scripts, and evaluation utilities can be extended independently.
...
├── scripts/
│   └── smoke_test.py
├── src/dexgrasp_anything_unofficial/
│   ├── __init__.py
│   └── model.py
├── CITATION.cff
├── README.md
...
```python
import torch
from dexgrasp_anything_unofficial import ModelConfig, UnofficialModel, reconstruction_loss
...
```python
import torch
from dexgrasp_anything_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables, pp. 22584-22594 | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Zhong_DexGrasp_Anything_Towards_Universal_Robotic_Dexterous_Grasping_with_Physics_Awareness_CVPR_2025_paper.html) |
| Ablation study | Ablation / experiment section | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Zhong_DexGrasp_Anything_Towards_Universal_Robotic_Dexterous_Grasping_with_Physics_Awareness_CVPR_2025_paper.html) |
| Qualitative examples | Main paper figures and supplemental material | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Zhong_DexGrasp_Anything_Towards_Universal_Robotic_Dexterous_Grasping_with_Physics_Awareness_CVPR_2025_paper.html) |
...
- Thanks to the authors of **DexGrasp Anything: Towards Universal Robotic Dexterous Grasping with Physics Awareness** for the original research.
...
cvpr-2025, pytorch, unofficial-implementation, robotic-grasping, dexterous-manipulation, robotics
